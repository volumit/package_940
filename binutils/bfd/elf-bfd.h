...
#ifdef HTC_SUPPORT
  flagword (*get_default_section_flags)(bfd *,asection *);
  bfd_boolean (*match_sections_by_type)(bfd *, const asection *, bfd *, const
                                       asection *);
#endif
};
...
#ifdef HTC_SUPPORT
extern flagword _bfd_elf_get_default_section_flags(bfd *,asection *);
#endif
