...
extern void ppc_elf_frag_check(fragS *);
#define md_frag_check(FRAGP)    ppc_elf_frag_check(FRAGP)

extern bfd_boolean ppcvle_dollar_dot(void);
#define md_dollar_dot           ppcvle_dollar_dot
...
/* Handle relaxation of PPC-VLE instructions.  */
...
#ifdef HTC_PPCVLE
extern char *ppc_elf_check_section_name(char *);
#define md_elf_check_section_name(NAME)         ppc_elf_check_section_name(NAME)
#endif
...
#define DWARF2_LINE_MIN_INSN_LENGTH     ((ppc_cpu & PPC_OPCODE_VLE)? 2: 4)
