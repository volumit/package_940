...
#ifndef __MCS_VERSIONS_H
#define __MCS_VERSIONS_H

#define HTC_ARCH_NAME "GTM MCS"
...
/* Version for building unique tag names like MCS_VN_M */
...
#define TOOL_VERSION_AR		"v1.0"
#define TOOL_VERSION_GAS	"v1.0"
#define TOOL_VERSION_LD		"v1.0"
#define TOOL_VERSION_NM		"v1.0"
#define TOOL_VERSION_OBJCOPY	"v1.0"
#define TOOL_VERSION_OBJDUMP	"v1.0"
#define TOOL_VERSION_RANLIB	"v1.0"
#define TOOL_VERSION_READELF	"v1.0"
#define TOOL_VERSION_SIZE	"v1.0"
