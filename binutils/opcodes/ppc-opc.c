...
static unsigned long insert_siA (unsigned long, long, ppc_cpu_t, const char **);
static long extract_siA (unsigned long, ppc_cpu_t, int *);
static unsigned long insert_uiA (unsigned long, long, ppc_cpu_t, const char **);
static long extract_uiA (unsigned long, ppc_cpu_t, int *);
...
static unsigned long insert_oim5 (unsigned long, long, ppc_cpu_t, const char **);
static long extract_oim5 (unsigned long, ppc_cpu_t, int *);
static unsigned long insert_li20 (unsigned long, long, ppc_cpu_t, const char **);
static long extract_li20 (unsigned long, ppc_cpu_t, int *);
static unsigned long insert_ui16L (unsigned long, long, ppc_cpu_t, const char **);
static long extract_ui16L (unsigned long, ppc_cpu_t, int *);
#if 0
static unsigned long insert_bd8 (unsigned long, long, ppc_cpu_t, const char **);
static long extract_bd8 (unsigned long, ppc_cpu_t, int *);
#endif
#endif /* HTC_PPCVLE */

/* The operands table.
...
#define CRFD BF
  { 0x7, 23, NULL, NULL, PPC_OPERAND_CR | PPC_OPERAND_CR_REG},
...
#define BFA OBF + 1
  { 0x7, 18, NULL, NULL, PPC_OPERAND_CR | PPC_OPERAND_CR_REG },
...
#define CRFS CRB + 1
  { 0x7, 0, NULL, NULL, PPC_OPERAND_CR  | PPC_OPERAND_CR_REG},
...
#define MBE ME + 1
  ...
  { -1, 0, insert_mbe, extract_mbe,  PPC_OPERAND_VLE_MBE},
...
#define NSI NB + 1
  ...
  /* The RA field in an D, DS, DQ, X, XO, M, SCI8 or MDS form instruction.  */
#define RA NSI + 1
#define iRA RA
#define _RA RA
...
#define RT_MASK (0x1f << 21)
  ...
  /* only even register allowed */
#define _RDE     RS + 1
#define RDE_MASK (0x1e << 21)
...
#define ZVUIMM_2 EVUIMM_2 
  { 0x3e, 10, NULL, NULL, PPC_OPERAND_PARENS },

  /* The other UIMM field in a word EVX form instruction.  */
#define EVUIMM_4 EVUIMM_2 + 1
#define ZVUIMM_4 EVUIMM_4 
...
#define ERAT_T UIM + 1
  ...
  /* the immediate operand in a SCI8 form instruction */
#define iSCI8 ERAT_T + 1
  { 0xffffffff, -1, insert_sci8, extract_sci8, 0 },

#define iSI16 iSCI8 + 1
  /* the immediate operand in a I16A form instruction */
  { 0xffff, -1, insert_siA, extract_siA, PPC_OPERAND_SIGNED | PPC_OPERAND_VLE_I16A },

#define iSI16SIGNOPT iSI16 + 1
  /* the immediate operand in a I16A form instruction */
  { 0xffff, -1, insert_siA, extract_siA, PPC_OPERAND_SIGNED |
    PPC_OPERAND_SIGNOPT | PPC_OPERAND_VLE_I16A },

#define iRY   iSI16SIGNOPT + 1
#define _RZ   iRY
  /* VLE register operand destination (RY/RZ) */
  { 0x1f, -1, insert_ry, extract_ry, PPC_OPERAND_VLE_GPR },

#define iARY   iRY + 1
  /* VLE register operand destination (RY/RZ) */
  { 0x1f, -1, insert_ary, extract_ary, PPC_OPERAND_VLE_AGPR },

#define _RX   iARY + 1
#define cRX   _RX
  /* VLE register operand source (RX) */
  { 0x1f, -1, insert_rx, extract_rx, PPC_OPERAND_VLE_GPR },

#define _ARX   _RX + 1
  /* VLE register operand source (RX) */
  { 0x1f, -1, insert_arx, extract_arx, PPC_OPERAND_VLE_AGPR },

#define iSD4 _ARX + 1
  /* SD4 format operand SD4 */
  { 0xf, 24, NULL, NULL, PPC_OPERAND_PARENS },

#define iSD41 iSD4 + 1
  /* SD4 format operand SD4 * 2 */
  { 0x1e, 23, NULL, NULL, PPC_OPERAND_PARENS },

#define iSD42 iSD41 + 1
  /* SD4 format operand SD4 * 4 */
  { 0x3c, 22, NULL, NULL, PPC_OPERAND_PARENS },

#define iD8 iSD42 + 1
#define _D8 iD8
  /* format D8 operand D8 */
  { 0xff, 0, NULL, NULL, PPC_OPERAND_PARENS | PPC_OPERAND_SIGNED },

#if 0
#define cRA iD8 + 1
  /* format D8 operand RA */
  { 0x1f, 16, NULL, NULL, PPC_OPERAND_GPR_0 },
...
#define _CRD32 iD8 + 1
  /* format SCI8 operand BF32 */
  { 0x3, 21, NULL, NULL, PPC_OPERAND_CR  | PPC_OPERAND_CR_REG},

  /* format M, SCI8 operand RS */
#define iRS     RT

#define iSI SI
#define iD  D

#define iOIM5 _CRD32 + 1
  /* format OIM5 operand OIM5 (value between 1 - 32) */
  { 0x3f, 16+4, insert_oim5, extract_oim5, 0 },

#define iUI5 iOIM5 + 1
  /* format IM5 operand UI5 */
  { 0x1f, 16+4, NULL,NULL,  0 },

#define iUI7 iUI5 + 1
  /* format IM7 operand UI7 */
  { 0x7f, 16+4, NULL,NULL,  0 },

#define iLI20 iUI7 + 1
  /* format LI20 operand li20 */
  { 0xfffff, -1, insert_li20, extract_li20, PPC_OPERAND_SIGNED | PPC_OPERAND_VLE_LI20 },

#define iUI16A iLI20 + 1
  /* format I16A operand UI16 */
  { 0xffff, -1, insert_uiA, extract_uiA, PPC_OPERAND_VLE_I16A },

#define iUI16L iUI16A + 1
  /* format I16L operand UI16 */
  { 0xffff, -1, insert_ui16L, extract_ui16L, PPC_OPERAND_VLE_I16L },
...
#define _BD24 iUI16L + 1
  /* BD24 format operand BD24 */
  { 0x01fffffe, 0, NULL, NULL, PPC_OPERAND_RELATIVE | PPC_OPERAND_SIGNED },

#define iBD15 _BD24 + 1
  /* BD15 Format operand BD15 */
  { 0xfffe, 0, NULL, NULL, PPC_OPERAND_RELATIVE | PPC_OPERAND_SIGNED },

#define iBI32 iBD15 + 1
  /* BD15 Format operand BI32 */
  { 0xf, 16, NULL, NULL, PPC_OPERAND_CR },

#define _BO32 iBI32 + 1
  /* BD15 Format operand BD15 */
  { 0x3, 20 , NULL, NULL, 0 },

#define _BO16 _BO32 + 1
  /* BD8 form operand BO16 */
  { 0x1, 16 + 10, NULL, NULL, 0 },

#define iBI16 _BO16 + 1
  /* BD8 form operand BI16 */
  { 0x3, 16 + 8, NULL, NULL, PPC_OPERAND_CR },

#define _BD8 iBI16 + 1
#define iBD8 _BD8
  /* BD8 form operand BD8 */
  //{ 0x1fe, -1, insert_bd8, extract_bd8, PPC_OPERAND_RELATIVE | PPC_OPERAND_SIGNED },
  { 0x1fe, 15, NULL, NULL, PPC_OPERAND_RELATIVE | PPC_OPERAND_SIGNED },
...
#define SA _BD8 + 1
  { 0x1, 15, NULL, NULL, PPC_OPERAND_ABSOLUTE },

#define IU SA + 1
  { 0x1, 14, NULL, NULL, PPC_OPERAND_ABSOLUTE },

#define OU IU + 1
  { 0x1, 13, NULL, NULL, PPC_OPERAND_ABSOLUTE },

#define SS OU + 1
  { 0x3, 11, NULL, NULL, PPC_OPERAND_ABSOLUTE },

#define ZXTRW_OFFSET SS + 1
  { 0x3, 0, NULL, NULL, PPC_OPERAND_MINPLUS1 },

  /* The ELEV field in an e_sc instruction */
#define ELEV ZXTRW_OFFSET + 1
  { 0x1f, 11, NULL, NULL, PPC_OPERAND_OPTIONAL },
#endif /* HTC_PPCVLE */
};
...
#ifdef HTC_PPCVLE
/* insert and extract the immediate operand to/from an SCI8-FORM */
static unsigned long 
             ...
             const char **errmsg)
{
  ...
  if (!(dialect & PPC_OPCODE_VLE))
    {
      *errmsg = _("format only valid in VLE mode");
    }
  if (((value & ~0xff) == 0) || ((value & ~0xff) == 0xffffff00))
    {
      value &= 0xff;
      mask = (val & 0x80000000)? 0x400: 0;
    }
  else if (((value & ~0xff00) == 0) || ((value & ~0xff00) == 0xffff00ff))
    {
      mask = ((value & 0x80000000)? 0x400: 0) | 0x100;
      value = (val >> 8) & 0xff;
    }
  else if (((value & ~0xff0000) == 0) || ((value & ~0xff0000) == 0xff00ffff))
    {
      mask = ((val & 0x80000000)? 0x400: 0) | 0x200;
      value = (value >> 16) & 0xff;
    }
  else if (((value & ~0xff000000) == 0) || ((value & ~0xff000000) == 0x00ffffff))
    {
      mask = ((val & 1)? 0x400: 0) | 0x300;
      value = (value >> 24) & 0xff;
    }
  else
    {
      *errmsg = _("illegal constant in SCI8 format");
      value = 0;
      mask = 0;
    }
...
extract_sci8 (unsigned long insn,
              ...
              int *invalid)
{
  long value = (insn & 0x400)? 0xffffffff: 0; /* F field (fill value) */
  int shift = ((insn & 0x300) >> 8) * 8; /* SCL field (shift value) */
  ...
  value = (value & ~(0xff << shift)) | ((insn & 0xff) << shift); /* sci9 field */
  return value;
}
/* insert/extract the signed value to/from an I16A format */
static unsigned long 
insert_siA (unsigned long insn,
            long value,
            ppc_cpu_t dialect,
            const char **errmsg)
{
...
static long
extract_siA (unsigned long insn,
             ppc_cpu_t dialect,
             int *invalid)
{
  short value;
  ...
  value = ((insn & 0x03e00000) >> 10) | (insn & 0x7ff);
  return value;
}
/* insert/extract the unsigned value to/from an I16A format */
static unsigned long 
insert_uiA (unsigned long insn,
            long value,
            ppc_cpu_t dialect,
            const char **errmsg)
{
...
static long
extract_uiA (unsigned long insn,
             ppc_cpu_t dialect,
             int *invalid)
{
  long value;
...
static unsigned long
insert_ui16L (unsigned long insn,
            long value,
            ppc_cpu_t dialect,
            const char **errmsg)
{
...
static long
extract_ui16L (unsigned long insn,
             ppc_cpu_t dialect,
             int *invalid)
{
  long value;
  ...
  value = ((insn & 0x001f0000) >> 5) | (insn & 0x7ff);
  return value;
}
static unsigned long
            ...
            const char **errmsg)
{
  ...
  return insn | ((value & 0xf0000) >> 5) | ((value & 0xf800) << 5) | (value & 0x7ff);
}
static long
             ...
             int *invalid)
{
  ...
  value |= ((insn & 0x00007800) << 5) | ((insn & 0x001f0000) >> 5) | (insn & 0x7ff);

  return value;
}

/* handle insert/extract of a vlid GPR in 16-Bit instructions 
   valid GPRS are GPR0-GPR7 and GPR24-GPR31 */
static unsigned long
            ...
            const char **errmsg)
{
  ...
  if ((value > 31) || (value < 0) || ((value > 7) && value < 24))
    {
      *errmsg = _("illegal register in 16-Bit VLE instruction");
    }
  if (value <= 7)
    return insn | ((value & 7) << 20);
  return insn | (((value - 16) & 0xf) << 20);
}
static long
            ...
            const char **errmsg)
{
  ...
  if (value <= 7)
    return insn | ((value & 7) << 16);
  return insn | (((value - 16) & 0xf)  << 16);
}
static long
             ...
             int *invalid)
{
  ...
  value = ((insn & 0x000f0000) >> 16);
  if (value & 0x8)
    value += 16;
  return value;
}

/* handle insert/extract of a valid alternative GPR in 16-Bit instructions 
   valid GPRS are GPR8-GPR23 */
static unsigned long
...
static unsigned long
insert_oim5 (unsigned long insn,
            long value,
            ppc_cpu_t dialect,
            const char **errmsg)
{
  ...
  if ((value > 32) || (value < 1))
    {
      *errmsg = _("illegal immediate value in 16-Bit VLE instruction");
    }
  value -= 1;
  return insn | ((value & 0x1f) << (16 + 4));
}
static long
extract_oim5 (unsigned long insn,
             ppc_cpu_t dialect,
             int *invalid)
{
  short value;
  ...
  value = ((insn & 0x01f00000) >> (16+4));
  value += 1;
  return value;
}
#if 0
static unsigned long
insert_bd8 (unsigned long insn,
            long value,
            ppc_cpu_t dialect,
            const char **errmsg)
{
  ...
  if ((value > 255) || (value < -256) || (value % 2))
    {
      *errmsg = _("illegal offset value in 16-Bit VLE instruction");
    }
  return insn | ((value & 0x1fe) << (15));
}
static long
extract_bd8 (unsigned long insn,
             ppc_cpu_t dialect,
             int *invalid)
{
  long value;
...
/* An VXRB form instruction.  bits 16-20  constant */
#define VXRB(op, xop) (OP (op) | (((unsigned long)(xop)) & 0xffff))

/* The mask for an VX form instruction. op2 bits 16-20 constant */
#define VXRB_MASK	VXRB(0x3f, 0xffff)

/* An VXRA form instruction.  bits 11-15  constant */
#define VXRA(op, xop,raop) (OP (op) | (((unsigned long)(raop) & 0x1f) << 16) | (((unsigned long)(xop)) & 0x7ff))

/* The mask for an VX form instruction. op1 bits 11-15 constant */
#define VXRA_MASK	VXRA(0x3f, 0x7ff, 0x1f)

/* An VXCR form instruction.  bits 9-10  constant */
#define VXCR(op, xop,crop) (OP (op) | (((unsigned long)(crop) & 0x3) << 21) | (((unsigned long)(xop)) & 0x7ff))

/* The mask for an VX form instruction. op0 use only bit 6-8 constant */
#define VXCR_MASK	VXCR(0x3f, 0x7ff, 0x3)
...
#ifdef HTC_PPCVLE
/* VLE format encodings */
#define Rc 1

#define OPCODEFORMAT_X   0xfc0007fe
#define OPCODEFORMAT_XL  0xfc0007fe
#define OPCODEFORMAT_XRc OPCODEFORMAT_X | Rc
#define OPCODEFORMAT_X1  OPCODEFORMAT_X | 1
#define OPCODEFORMAT_MPU OPCODEFORMAT_X | (1<<25)
#define OPCODEFORMAT_EFX 0xfc0007ff
#define OPCODEFORMAT_EFXSCX 0xfc0407ff
#define OPCODEFORMAT_Z   0xfc0007ff
#define OPCODEFORMAT_Z1  0xfc00ffff
#define OPCODEFORMAT_Z2  0xfc0007fc
#define OPCODEFORMAT_ZV  0xfc0007ff
#define OPCODEFORMAT_ZV1 0xfc00ffff
#define OPCODEFORMAT_ZVCMPX 0xfc6007ff

#define O_MPU(op,xop)     (OP (op) | (1U << 25) | ((((unsigned long)(xop)) & 0x3ff)<<1))
#define O_EFX(op,xop)     (OP (op) | (((unsigned long)(xop)) & 0x7ff))
#define O_EFSCXH(op,xop)  (OP (op) | (4U << 16) | (((unsigned long)(xop)) & 0x7ff))
#define O_X(op,xop)       (OP (op) | (((unsigned long)(xop)) & 0x7ff))
#define O_X1(op,xop)      (OP (op) | (((unsigned long)(xop)) & 0xffff))
#define O_Z(op,xop)       (OP (op) | (((unsigned long)(xop)) & 0xffff))
#define O_ZV(op,xop)      (OP (op) | (((unsigned long)(xop)) & 0xffff))
#define O_ZVCMPX(op,xop,xop1)    (OP (op) | ((((unsigned long)(xop1)) & 0x3) << 21) | (((unsigned long)(xop)) & 0xffff))

/* the vle 16-bit opcode formats */
#define OVLE16_B8(op) (((unsigned long)(op)) << 24)
#define OVLE16_BO8(op) (((unsigned long)(op)) << 27)
#define OVLE16_C(op) (((unsigned long)(op)) << 16)
#define OVLE16_IM5(op) (((unsigned long)(op)) << 25)
#define OVLE16_IM7(op) (((unsigned long)(op)) << 27)
#define OVLE16_R(op) (((unsigned long)(op)) << 20)
#define OVLE16_RR(op) (((unsigned long)(op)) << 24)
#define OVLE16_SD4(op) (((unsigned long)(op)) << 28)

#define OPCODEFORMAT_B8  0xff000000
#define OPCODEFORMAT_BO8 0xf8000000
#define OPCODEFORMAT_C   0xffff0000
#define OPCODEFORMAT_IM5 0xfe000000
#define OPCODEFORMAT_IM7 0xf8000000
#define OPCODEFORMAT_R   0xfff00000
#define OPCODEFORMAT_RR  0xff000000
#define OPCODEFORMAT_SD4 0xf0000000


/* the vle 32-bit opcode formats */
#define OVLE32_BD15(op1, op2) ((((unsigned long)(op1)) << 22) | ((unsigned long)(op2)))
#define OVLE32_BD24(op1, op2) ((((unsigned long)(op1)) << 25) | ((unsigned long)(op2)))
#define OVLE32_D(op1) (((unsigned long)(op1)) <<26)
#define OVLE32_D8(op1, op2) ((((unsigned long)(op1)) << 26) | (((unsigned long)(op2)) << 8))
#define OVLE32_D82(op1, op2) ((((unsigned long)(op1)) << 21) | (((unsigned long)(op2)) << 8))
#define OVLE32_DI(op1) (((unsigned long)(op1)) << 26)
#define OVLE32_I16A(op1, op2) ((((unsigned long)(op1)) << 26) | (((unsigned long)(op2)) << 11))
#define OVLE32_I16L(op1, op2) ((((unsigned long)(op1)) << 26) | (((unsigned long)(op2)) << 11))
#define OVLE32_LI20(op1, op2) ((((unsigned long)(op1)) << 26) | (((unsigned long)(op2)) << 15))
#define OVLE32_RLWI(op1, op2) ((((unsigned long)(op1)) << 26) | (((unsigned long)(op2))))
#define OVLE32_SCI8CR(op1, op2) ((((unsigned long)(op1)) << 23) | (((unsigned long)(op2)) << 11))
#define OVLE32_SCI8RS(op1, op2) ((((unsigned long)(op1)) << 26) | (((unsigned long)(op2)) << 11))
#define OVLE32_SCI8RT(op1, op2) ((((unsigned long)(op1)) << 26) | (((unsigned long)(op2)) << 11))
#define OVLE32_X(op1, op2) ((((unsigned long)(op1)) << 26) | (((unsigned long)(op2)) << 1))
#define OVLE32_XL(op1, op2) ((((unsigned long)(op1)) << 26) | (((unsigned long)(op2)) << 1))
#define OVLE32_XRC(op1, op2) ((((unsigned long)(op1)) << 26) | ((unsigned long)(op2)))
#define OVLE32_ESC(op1, op2) ((((unsigned long)(op1)) << 26) | ((unsigned long)(op2)))

#define OPCODEFORMAT_BD15   0xffc00001
#define OPCODEFORMAT_BD24   0xfe000001
#define OPCODEFORMAT_D      0xfc000000
#define OPCODEFORMAT_D8     0xfc00ff00
#define OPCODEFORMAT_D82    0xffe0ff00
#define OPCODEFORMAT_DI     0xfc000000
#define OPCODEFORMAT_I16A   0xfc00f800
#define OPCODEFORMAT_I16L   0xfc00f800
#define OPCODEFORMAT_LI20   0xfc008000
#define OPCODEFORMAT_RLWI   0xfc000001
#define OPCODEFORMAT_SCI8CR 0xff80f800
#define OPCODEFORMAT_SCI8RS 0xfc00f800
#define OPCODEFORMAT_SCI8RT 0xfc00f800
#define OPCODEFORMAT_ESC    0xfc0007ff
...
#define PPCVLE16  PPC_OPCODE_VLE16 | PPC_OPCODE_VLE
#define PPCZEN420n3     PPC_OPCODE_ZEN420
#define PPCEFPU PPC_OPCODE_EFPU
#define PPCZENLSP PPC_OPCODE_LSP
#define PPCZENSAT PPC_OPCODE_SAT
#endif

/* The opcode table.
   ...
   DEPRECATED are one bit flags for the opcode.  These are used to indicate
     which specific processors no longer support the instructions.
...
#ifdef HTC_PPCVLE
{"eaddi",	OP(12),		OP_MASK,     PPCCOM,	PPCNONE,	{RT, RA, SI}},
{"eaddi.",	OP(12),		OP_MASK,     PPCVLE,	PPCNONE,	{RT, RA, SI}},
{"eaddis",	OP(15),		OP_MASK,     PPCVLE,	PPCNONE,	{RT, RA, SISIGNOPT}},
#endif
...
{"bdnzf-",   BBO(16,BODNZF,0,0),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDM}},
{"bdnzf+",   BBO(16,BODNZF,0,0),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDP}},
{"bdnzf",    BBO(16,BODNZF,0,0),	BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BD}},
{"bdnzfl-",  BBO(16,BODNZF,0,1),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDM}},
{"bdnzfl+",  BBO(16,BODNZF,0,1),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDP}},
{"bdnzfl",   BBO(16,BODNZF,0,1),	BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BD}},
{"bdnzfa-",  BBO(16,BODNZF,1,0),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDMA}},
{"bdnzfa+",  BBO(16,BODNZF,1,0),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDPA}},
{"bdnzfa",   BBO(16,BODNZF,1,0),	BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BDA}},
{"bdnzfla-", BBO(16,BODNZF,1,1),	BBOY_MASK,     PPCCOM,   PPCVLE,	{BI, BDMA}},
{"bdnzfla+", BBO(16,BODNZF,1,1),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDPA}},
{"bdnzfla",  BBO(16,BODNZF,1,1),	BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BDA}},


{"bdzf-",    BBO(16,BODZF,0,0),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDM}},
{"bdzf+",    BBO(16,BODZF,0,0),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDP}},
{"bdzf",     BBO(16,BODZF,0,0),		BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BD}},
{"bdzfl-",   BBO(16,BODZF,0,1),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDM}},
{"bdzfl+",   BBO(16,BODZF,0,1),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDP}},
{"bdzfl",    BBO(16,BODZF,0,1),		BBOY_MASK,     PPCCOM,	 PPCVLE       ,	{BI, BD}},
{"bdzfa-",   BBO(16,BODZF,1,0),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDMA}},
{"bdzfa+",   BBO(16,BODZF,1,0),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDPA}},
{"bdzfa",    BBO(16,BODZF,1,0),		BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BDA}},
{"bdzfla-",  BBO(16,BODZF,1,1),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDMA}},
{"bdzfla+",  BBO(16,BODZF,1,1),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDPA}},
...
{"bdnzt-",   BBO(16,BODNZT,0,0),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDM}},
{"bdnzt+",   BBO(16,BODNZT,0,0),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDP}},
{"bdnzt",    BBO(16,BODNZT,0,0),	BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BD}},
{"bdnztl-",  BBO(16,BODNZT,0,1),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDM}},
{"bdnztl+",  BBO(16,BODNZT,0,1),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDP}},
{"bdnztl",   BBO(16,BODNZT,0,1),	BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BD}},
{"bdnzta-",  BBO(16,BODNZT,1,0),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDMA}},
{"bdnzta+",  BBO(16,BODNZT,1,0),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDPA}},
{"bdnzta",   BBO(16,BODNZT,1,0),	BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BDA}},
{"bdnztla-", BBO(16,BODNZT,1,1),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDMA}},
{"bdnztla+", BBO(16,BODNZT,1,1),	BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDPA}},
{"bdnztla",  BBO(16,BODNZT,1,1),	BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BDA}},


    

{"bdzt-",    BBO(16,BODZT,0,0),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDM}},
{"bdzt+",    BBO(16,BODZT,0,0),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDP}},
{"bdzt",     BBO(16,BODZT,0,0),		BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BD}},
{"bdztl-",   BBO(16,BODZT,0,1),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDM}},
{"bdztl+",   BBO(16,BODZT,0,1),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDP}},
{"bdztl",    BBO(16,BODZT,0,1),		BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BD}},
{"bdzta-",   BBO(16,BODZT,1,0),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDMA}},
{"bdzta+",   BBO(16,BODZT,1,0),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDPA}},
{"bdzta",    BBO(16,BODZT,1,0),		BBOY_MASK,     PPCCOM,	 PPCVLE,	{BI, BDA}},
{"bdztla-",  BBO(16,BODZT,1,1),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDMA}},
{"bdztla+",  BBO(16,BODZT,1,1),		BBOY_MASK,     PPCCOM,   POWER4|PPCVLE,	{BI, BDPA}},
{"bdztla",   BBO(16,BODZT,1,1),		BBOY_MASK,     PPCCOM,	 PPCNONE|PPCVLE,	{BI, BDA}},
...
{"bdnzlr-",  XLO(19,BODNZ,16,0),	XLBOBIBB_MASK, PPCCOM,   POWER4|PPCVLE,	{0}},
{"bdnzlrl",  XLO(19,BODNZ,16,1),	XLBOBIBB_MASK, PPCCOM,	 PPCVLE,	{0}},
{"bdnzlrl-", XLO(19,BODNZ,16,1),	XLBOBIBB_MASK, PPCCOM,   POWER4|PPCVLE,	{0}},
{"bdnzlr+",  XLO(19,BODNZP,16,0),	XLBOBIBB_MASK, PPCCOM,   POWER4|PPCVLE,	{0}},
{"bdnzlrl+", XLO(19,BODNZP,16,1),	XLBOBIBB_MASK, PPCCOM,   POWER4|PPCVLE,	{0}},



{"bdzlr",    XLO(19,BODZ,16,0),		XLBOBIBB_MASK, PPCCOM,	 PPCVLE ,	{0}},
{"bdzlr-",   XLO(19,BODZ,16,0),		XLBOBIBB_MASK, PPCCOM,   POWER4|PPCVLE,	{0}},
{"bdzlrl",   XLO(19,BODZ,16,1),		XLBOBIBB_MASK, PPCCOM,	 PPCVLE       ,	{0}},
{"bdzlrl-",  XLO(19,BODZ,16,1),		XLBOBIBB_MASK, PPCCOM,   POWER4|PPCVLE,	{0}},
{"bdzlr+",   XLO(19,BODZP,16,0),	XLBOBIBB_MASK, PPCCOM,   POWER4|PPCVLE,	{0}},
{"bdzlrl+",  XLO(19,BODZP,16,1),	XLBOBIBB_MASK, PPCCOM,   POWER4|PPCVLE,	{0}},
...
{"bdnzlr-",  XLO(19,BODNZM4,16,0),	XLBOBIBB_MASK, POWER4,	 PPCVLE,	{0}},
{"bdnzlrl-", XLO(19,BODNZM4,16,1),	XLBOBIBB_MASK, POWER4,	 PPCVLE,	{0}},
{"bdnzlr+",  XLO(19,BODNZP4,16,0),	XLBOBIBB_MASK, POWER4,	 PPCVLE,	{0}},
{"bdnzlrl+", XLO(19,BODNZP4,16,1),	XLBOBIBB_MASK, POWER4,	 PPCVLE,	{0}},


    
{"bdzlr-",   XLO(19,BODZM4,16,0),	XLBOBIBB_MASK, POWER4,	 PPCVLE       ,	{0}},
{"bdzlrl-",  XLO(19,BODZM4,16,1),	XLBOBIBB_MASK, POWER4,	 PPCVLE       ,	{0}},
{"bdzlr+",   XLO(19,BODZP4,16,0),	XLBOBIBB_MASK, POWER4,	 PPCVLE       ,	{0}},
{"bdzlrl+",  XLO(19,BODZP4,16,1),	XLBOBIBB_MASK, POWER4,	 PPCVLE       ,	{0}},


    
{"bgelr",    XLOCB(19,BOF,CBLT,16,0),	XLBOCBBB_MASK, PPCCOM,	 PPCVLE,	{CR}},
{"bgelr-",   XLOCB(19,BOF,CBLT,16,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
...
{"bgelrl-",  XLOCB(19,BOF,CBLT,16,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
...
{"bgelr+",   XLOCB(19,BOFP,CBLT,16,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},

{"bnllr+",   XLOCB(19,BOFP,CBLT,16,0),	XLBOCBBB_MASK, PPCCOM,   POWER4,	{CR}},

{"bgelrl+",  XLOCB(19,BOFP,CBLT,16,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},

{"bnllrl+",  XLOCB(19,BOFP,CBLT,16,1),	XLBOCBBB_MASK, PPCCOM,   POWER4,	{CR}},

{"blelr+",   XLOCB(19,BOFP,CBGT,16,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},

{"bnglr+",   XLOCB(19,BOFP,CBGT,16,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},

{"blelrl+",  XLOCB(19,BOFP,CBGT,16,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},

{"bnglrl+",  XLOCB(19,BOFP,CBGT,16,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
...
{"bgelr-",   XLOCB(19,BOFM4,CBLT,16,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bnllr-",   XLOCB(19,BOFM4,CBLT,16,0),	XLBOCBBB_MASK, POWER4,	 PPCNONE,	{CR}},

{"bgelrl-",  XLOCB(19,BOFM4,CBLT,16,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bnllrl-",  XLOCB(19,BOFM4,CBLT,16,1),	XLBOCBBB_MASK, POWER4,	 PPCNONE,	{CR}},

{"blelr-",   XLOCB(19,BOFM4,CBGT,16,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bnglr-",   XLOCB(19,BOFM4,CBGT,16,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"blelrl-",  XLOCB(19,BOFM4,CBGT,16,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bnglrl-",  XLOCB(19,BOFM4,CBGT,16,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
...
{"bgelr+",   XLOCB(19,BOFP4,CBLT,16,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bnllr+",   XLOCB(19,BOFP4,CBLT,16,0),	XLBOCBBB_MASK, POWER4,	 PPCNONE,	{CR}},

{"bgelrl+",  XLOCB(19,BOFP4,CBLT,16,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bnllrl+",  XLOCB(19,BOFP4,CBLT,16,1),	XLBOCBBB_MASK, POWER4,	 PPCNONE,	{CR}},

{"blelr+",   XLOCB(19,BOFP4,CBGT,16,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bnglr+",   XLOCB(19,BOFP4,CBGT,16,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"blelrl+",  XLOCB(19,BOFP4,CBGT,16,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bnglrl+",  XLOCB(19,BOFP4,CBGT,16,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
...
{"bgtlr+",   XLOCB(19,BOTP,CBGT,16,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
{"bgtlrl+",  XLOCB(19,BOTP,CBGT,16,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},


{"beqlr+",   XLOCB(19,BOTP,CBEQ,16,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
{"beqlrl+",  XLOCB(19,BOTP,CBEQ,16,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
...
{"bgtlr-",   XLOCB(19,BOTM4,CBGT,16,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"bgtlrl-",  XLOCB(19,BOTM4,CBGT,16,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},


{"beqlr-",   XLOCB(19,BOTM4,CBEQ,16,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"beqlrl-",  XLOCB(19,BOTM4,CBEQ,16,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
...
{"bgtlr+",   XLOCB(19,BOTP4,CBGT,16,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"bgtlrl+",  XLOCB(19,BOTP4,CBGT,16,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},


{"beqlr+",   XLOCB(19,BOTP4,CBEQ,16,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"beqlrl+",  XLOCB(19,BOTP4,CBEQ,16,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
...
{"bdnzflr-", XLO(19,BODNZF,16,0),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdnzflrl", XLO(19,BODNZF,16,1),	XLBOBB_MASK,   PPCCOM,	 PPCVLE,	{BI}},
{"bdnzflrl-",XLO(19,BODNZF,16,1),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdnzflr+", XLO(19,BODNZFP,16,0),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdnzflrl+",XLO(19,BODNZFP,16,1),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},


{"bdzflr",   XLO(19,BODZF,16,0),	XLBOBB_MASK,   PPCCOM,	 PPCVLE       ,	{BI}},
{"bdzflr-",  XLO(19,BODZF,16,0),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdzflrl",  XLO(19,BODZF,16,1),	XLBOBB_MASK,   PPCCOM,	 PPCVLE,	{BI}},
{"bdzflrl-", XLO(19,BODZF,16,1),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdzflr+",  XLO(19,BODZFP,16,0),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdzflrl+", XLO(19,BODZFP,16,1),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},



{"bflr",     XLO(19,BOF,16,0),		XLBOBB_MASK,   PPCCOM,	 PPCVLE,	{BI}},
{"bflr-",    XLO(19,BOF,16,0),		XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
...
{"bflrl-",   XLO(19,BOF,16,1),		XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},


{"bbfrl",    XLO(19,BOF,16,1),		XLBOBB_MASK,   PWRCOM,	 PPCNONE,	{BI}},

{"bflr+",    XLO(19,BOFP,16,0),		XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bflrl+",   XLO(19,BOFP,16,1),		XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bflr-",    XLO(19,BOFM4,16,0),	XLBOBB_MASK,   POWER4,	 PPCVLE,	{BI}},
{"bflrl-",   XLO(19,BOFM4,16,1),	XLBOBB_MASK,   POWER4,	 PPCVLE,	{BI}},
{"bflr+",    XLO(19,BOFP4,16,0),	XLBOBB_MASK,   POWER4,	 PPCVLE,	{BI}},
{"bflrl+",   XLO(19,BOFP4,16,1),	XLBOBB_MASK,   POWER4,	 PPCVLE,	{BI}},


{"bdnztlr",  XLO(19,BODNZT,16,0),	XLBOBB_MASK,   PPCCOM,	 PPCVLE,	{BI}},
{"bdnztlr-", XLO(19,BODNZT,16,0),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdnztlrl", XLO(19,BODNZT,16,1),	XLBOBB_MASK,   PPCCOM,	 PPCVLE,	{BI}},
{"bdnztlrl-",XLO(19,BODNZT,16,1),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdnztlr+", XLO(19,BODNZTP,16,0),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdnztlrl+",XLO(19,BODNZTP,16,1),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},


{"bdztlr",   XLO(19,BODZT,16,0),	XLBOBB_MASK,   PPCCOM,	 PPCVLE,	{BI}},
{"bdztlr-",  XLO(19,BODZT,16,0),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdztlrl",  XLO(19,BODZT,16,1),	XLBOBB_MASK,   PPCCOM,	 PPCVLE,	{BI}},
{"bdztlrl-", XLO(19,BODZT,16,1),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdztlr+",  XLO(19,BODZTP,16,0),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bdztlrl+", XLO(19,BODZTP,16,1),	XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
...
{"bgectr-", XLOCB(19,BOF,CBLT,528,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
...
{"bgectrl-",XLOCB(19,BOF,CBLT,528,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
...
{"blectr-", XLOCB(19,BOF,CBGT,528,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},

{"bngctr",  XLOCB(19,BOF,CBGT,528,0),	XLBOCBBB_MASK, PPCCOM,	 PPCVLE,	{CR}},
{"bngctr-", XLOCB(19,BOF,CBGT,528,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},

{"blectrl", XLOCB(19,BOF,CBGT,528,1),	XLBOCBBB_MASK, PPCCOM,	 PPCVLE,	{CR}},
{"blectrl-",XLOCB(19,BOF,CBGT,528,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},

{"bngctrl", XLOCB(19,BOF,CBGT,528,1),	XLBOCBBB_MASK, PPCCOM,	 PPCVLE,	{CR}},
{"bngctrl-",XLOCB(19,BOF,CBGT,528,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
...
{"bgectr+", XLOCB(19,BOFP,CBLT,528,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
{"bnlctr+", XLOCB(19,BOFP,CBLT,528,0),	XLBOCBBB_MASK, PPCCOM,   POWER4,	{CR}},
{"bgectrl+",XLOCB(19,BOFP,CBLT,528,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
{"bnlctrl+",XLOCB(19,BOFP,CBLT,528,1),	XLBOCBBB_MASK, PPCCOM,   POWER4,	{CR}},
{"blectr+", XLOCB(19,BOFP,CBGT,528,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},

{"bngctr+", XLOCB(19,BOFP,CBGT,528,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},

{"blectrl+",XLOCB(19,BOFP,CBGT,528,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},

{"bngctrl+",XLOCB(19,BOFP,CBGT,528,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
...
{"bgectr-", XLOCB(19,BOFM4,CBLT,528,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"bnlctr-", XLOCB(19,BOFM4,CBLT,528,0),	XLBOCBBB_MASK, POWER4,	 PPCNONE,	{CR}},
{"bgectrl-",XLOCB(19,BOFM4,CBLT,528,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"bnlctrl-",XLOCB(19,BOFM4,CBLT,528,1),	XLBOCBBB_MASK, POWER4,	 PPCNONE,	{CR}},
{"blectr-", XLOCB(19,BOFM4,CBGT,528,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bngctr-", XLOCB(19,BOFM4,CBGT,528,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"blectrl-",XLOCB(19,BOFM4,CBGT,528,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bngctrl-",XLOCB(19,BOFM4,CBGT,528,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
...
{"bgectr+", XLOCB(19,BOFP4,CBLT,528,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"bnlctr+", XLOCB(19,BOFP4,CBLT,528,0),	XLBOCBBB_MASK, POWER4,	 PPCNONE,	{CR}},
{"bgectrl+",XLOCB(19,BOFP4,CBLT,528,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"bnlctrl+",XLOCB(19,BOFP4,CBLT,528,1),	XLBOCBBB_MASK, POWER4,	 PPCNONE,	{CR}},
{"blectr+", XLOCB(19,BOFP4,CBGT,528,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bngctr+", XLOCB(19,BOFP4,CBGT,528,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"blectrl+",XLOCB(19,BOFP4,CBGT,528,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},

{"bngctrl+",XLOCB(19,BOFP4,CBGT,528,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
...
{"bgtctr-", XLOCB(19,BOT,CBGT,528,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
{"bgtctrl", XLOCB(19,BOT,CBGT,528,1),	XLBOCBBB_MASK, PPCCOM,	 PPCVLE,	{CR}},
{"bgtctrl-",XLOCB(19,BOT,CBGT,528,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
{"beqctr",  XLOCB(19,BOT,CBEQ,528,0),	XLBOCBBB_MASK, PPCCOM,	 PPCVLE,	{CR}},
{"beqctr-", XLOCB(19,BOT,CBEQ,528,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
{"beqctrl", XLOCB(19,BOT,CBEQ,528,1),	XLBOCBBB_MASK, PPCCOM,	 PPCVLE,	{CR}},
{"beqctrl-",XLOCB(19,BOT,CBEQ,528,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
...
{"bgtctr+", XLOCB(19,BOTP,CBGT,528,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
{"bgtctrl+",XLOCB(19,BOTP,CBGT,528,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
{"beqctr+", XLOCB(19,BOTP,CBEQ,528,0),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
{"beqctrl+",XLOCB(19,BOTP,CBEQ,528,1),	XLBOCBBB_MASK, PPCCOM,   POWER4|PPCVLE,	{CR}},
...
{"bgtctr-", XLOCB(19,BOTM4,CBGT,528,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"bgtctrl-",XLOCB(19,BOTM4,CBGT,528,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},


{"beqctr-", XLOCB(19,BOTM4,CBEQ,528,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"beqctrl-",XLOCB(19,BOTM4,CBEQ,528,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
...
{"bgtctr+", XLOCB(19,BOTP4,CBGT,528,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"bgtctrl+",XLOCB(19,BOTP4,CBGT,528,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},


{"beqctr+", XLOCB(19,BOTP4,CBEQ,528,0),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
{"beqctrl+",XLOCB(19,BOTP4,CBEQ,528,1),	XLBOCBBB_MASK, POWER4,	 PPCVLE,	{CR}},
...
{"bfctr-",  XLO(19,BOF,528,0),		XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bfctrl",  XLO(19,BOF,528,1),		XLBOBB_MASK,   PPCCOM,	 PPCVLE,	{BI}},
{"bfctrl-", XLO(19,BOF,528,1),		XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bfctr+",  XLO(19,BOFP,528,0),		XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bfctrl+", XLO(19,BOFP,528,1),		XLBOBB_MASK,   PPCCOM,   POWER4|PPCVLE,	{BI}},
{"bfctr-",  XLO(19,BOFM4,528,0),	XLBOBB_MASK,   POWER4,	 PPCVLE,	{BI}},
{"bfctrl-", XLO(19,BOFM4,528,1),	XLBOBB_MASK,   POWER4,	 PPCVLE,	{BI}},
{"bfctr+",  XLO(19,BOFP4,528,0),	XLBOBB_MASK,   POWER4,	 PPCVLE,	{BI}},
{"bfctrl+", XLO(19,BOFP4,528,1),	XLBOBB_MASK,   POWER4,	 PPCVLE,	{BI}},
...
{"popcntb",	X(31,122),	XRB_MASK,    COM,	PPCNONE,	{RA, RS}},
...
{"mfspefscr",	XSPR(31,339,512), XSPR_MASK, PPCSPE|PPCEFPU,	PPCNONE,	{RT}},
...
{"stfsx",	X(31,663),	X_MASK,      COM,	PPCVLE,	{FRS, RA0, RB}},
...
{"stfsux",	X(31,695),	X_MASK,      COM,	PPCVLE,	{FRS, RAS, RB}},
...
{"stfdx",	X(31,727),	X_MASK,      COM,	PPCVLE,	{FRS, RA0, RB}},
...
{"stfdepx",	X(31,735),	X_MASK,   E500MC|PPCA2,	PPCVLE,	{FRS, RA, RB}},
...
{"stfdux",	X(31,759),	X_MASK,      COM,	PPCVLE,	{FRS, RAS, RB}},
...
{"stfdpx",	X(31,919),	X_MASK,      POWER6,	PPCVLE,	{FRS, RA, RB}},
...
{"stfddx",	X(31,931),	X_MASK,      E500MC,	PPCVLE,	{FRS, RA, RB}},
...
{"stfiwx",	X(31,983),	X_MASK,      PPC,	PPCVLE,	{FRS, RA0, RB}},
...
{"stfs",	OP(52),		OP_MASK,     COM,	PPCVLE,	{FRS, D, RA0}},

{"stfsu",	OP(53),		OP_MASK,     COM,	PPCVLE,	{FRS, D, RAS}},

{"stfd",	OP(54),		OP_MASK,     COM,	PPCVLE,	{FRS, D, RA0}},

{"stfdu",	OP(55),		OP_MASK,     COM,	PPCVLE,	{FRS, D, RAS}},
...
{"fdivs",	A(59,18,0),	AFRC_MASK,   PPC,	PPCVLE,	{FRT, FRA, FRB}},
{"fdivs.",	A(59,18,1),	AFRC_MASK,   PPC,	PPCVLE,	{FRT, FRA, FRB}},

{"fsubs",	A(59,20,0),	AFRC_MASK,   PPC,	PPCVLE,	{FRT, FRA, FRB}},
{"fsubs.",	A(59,20,1),	AFRC_MASK,   PPC,	PPCVLE,	{FRT, FRA, FRB}},

{"fadds",	A(59,21,0),	AFRC_MASK,   PPC,	PPCVLE,	{FRT, FRA, FRB}},
{"fadds.",	A(59,21,1),	AFRC_MASK,   PPC,	PPCVLE,	{FRT, FRA, FRB}},
...
{"fmuls",	A(59,25,0),	AFRB_MASK,   PPC,	PPCVLE,	{FRT, FRA, FRC}},
{"fmuls.",	A(59,25,1),	AFRB_MASK,   PPC,	PPCVLE,	{FRT, FRA, FRC}},
...
{"fmadds",	A(59,29,0),	A_MASK,      PPC,	PPCVLE,	{FRT, FRA, FRC, FRB}},
{"fmadds.",	A(59,29,1),	A_MASK,      PPC,	PPCVLE,	{FRT, FRA, FRC, FRB}},

{"fnmsubs",	A(59,30,0),	A_MASK,      PPC,	PPCVLE,	{FRT, FRA, FRC, FRB}},
{"fnmsubs.",	A(59,30,1),	A_MASK,      PPC,	PPCVLE,	{FRT, FRA, FRC, FRB}},

{"fnmadds",	A(59,31,0),	A_MASK,      PPC,	PPCVLE,	{FRT, FRA, FRC, FRB}},
{"fnmadds.",	A(59,31,1),	A_MASK,      PPC,	PPCVLE,	{FRT, FRA, FRC, FRB}},
...
{"stfdp",	OP(61),		OP_MASK,     POWER6,	PPCVLE,	{FRT, D, RA0}},
...
{"fcmpu",	X(63,0),     X_MASK|(3<<21), COM,	PPCVLE,	{BF, FRA, FRB}},
...
{"frsp",	XRC(63,12,0),	XRA_MASK,    COM,	PPCVLE,	{FRT, FRB}},
{"frsp.",	XRC(63,12,1),	XRA_MASK,    COM,	PPCVLE,	{FRT, FRB}},

{"fctiw",	XRC(63,14,0),	XRA_MASK,    PPCCOM,	PPCVLE,	{FRT, FRB}},
{"fcir",	XRC(63,14,0),	XRA_MASK,    POWER2,	PPCNONE,	{FRT, FRB}},
{"fctiw.",	XRC(63,14,1),	XRA_MASK,    PPCCOM,	PPCVLE,	{FRT, FRB}},
{"fcir.",	XRC(63,14,1),	XRA_MASK,    POWER2,	PPCNONE,	{FRT, FRB}},

{"fctiwz",	XRC(63,15,0),	XRA_MASK,    PPCCOM,	PPCVLE,	{FRT, FRB}},
{"fcirz",	XRC(63,15,0),	XRA_MASK,    POWER2,	PPCNONE,	{FRT, FRB}},
{"fctiwz.",	XRC(63,15,1),	XRA_MASK,    PPCCOM,	PPCVLE,	{FRT, FRB}},
{"fcirz.",	XRC(63,15,1),	XRA_MASK,    POWER2,	PPCNONE,	{FRT, FRB}},

{"fdiv",	A(63,18,0),	AFRC_MASK,   PPCCOM,	PPCVLE,	{FRT, FRA, FRB}},
{"fd",		A(63,18,0),	AFRC_MASK,   PWRCOM,	PPCNONE,	{FRT, FRA, FRB}},
{"fdiv.",	A(63,18,1),	AFRC_MASK,   PPCCOM,	PPCVLE,	{FRT, FRA, FRB}},
{"fd.",		A(63,18,1),	AFRC_MASK,   PWRCOM,	PPCNONE,	{FRT, FRA, FRB}},

{"fsub",	A(63,20,0),	AFRC_MASK,   PPCCOM,	PPCVLE,	{FRT, FRA, FRB}},
{"fs",		A(63,20,0),	AFRC_MASK,   PWRCOM,	PPCNONE,	{FRT, FRA, FRB}},
{"fsub.",	A(63,20,1),	AFRC_MASK,   PPCCOM,	PPCVLE,	{FRT, FRA, FRB}},
{"fs.",		A(63,20,1),	AFRC_MASK,   PWRCOM,	PPCNONE,	{FRT, FRA, FRB}},

{"fadd",	A(63,21,0),	AFRC_MASK,   PPCCOM,	PPCVLE,	{FRT, FRA, FRB}},
{"fa",		A(63,21,0),	AFRC_MASK,   PWRCOM,	PPCNONE,	{FRT, FRA, FRB}},
{"fadd.",	A(63,21,1),	AFRC_MASK,   PPCCOM,	PPCVLE,	{FRT, FRA, FRB}},
...
{"fsel",	A(63,23,0),	A_MASK,      PPC,	PPCVLE,	{FRT, FRA, FRC, FRB}},
{"fsel.",	A(63,23,1),	A_MASK,      PPC,	PPCVLE,	{FRT, FRA, FRC, FRB}},
...
{"fmul",	A(63,25,0),	AFRB_MASK,   PPCCOM,	PPCVLE,	{FRT, FRA, FRC}},
{"fm",		A(63,25,0),	AFRB_MASK,   PWRCOM,	PPCNONE,	{FRT, FRA, FRC}},
{"fmul.",	A(63,25,1),	AFRB_MASK,   PPCCOM,	PPCVLE,	{FRT, FRA, FRC}},
...
{"fmadd",	A(63,29,0),	A_MASK,      PPCCOM,	PPCVLE,	{FRT, FRA, FRC, FRB}},
{"fma",		A(63,29,0),	A_MASK,      PWRCOM,	PPCNONE,	{FRT, FRA, FRC, FRB}},
{"fmadd.",	A(63,29,1),	A_MASK,      PPCCOM,	PPCVLE,	{FRT, FRA, FRC, FRB}},
{"fma.",	A(63,29,1),	A_MASK,      PWRCOM,	PPCNONE,	{FRT, FRA, FRC, FRB}},

{"fnmsub",	A(63,30,0),	A_MASK,      PPCCOM,	PPCVLE,	{FRT, FRA, FRC, FRB}},
{"fnms",	A(63,30,0),	A_MASK,      PWRCOM,	PPCVLE,	{FRT, FRA, FRC, FRB}},
{"fnmsub.",	A(63,30,1),	A_MASK,      PPCCOM,	PPCVLE,	{FRT, FRA, FRC, FRB}},
{"fnms.",	A(63,30,1),	A_MASK,      PWRCOM,	PPCVLE,	{FRT, FRA, FRC, FRB}},

{"fnmadd",	A(63,31,0),	A_MASK,      PPCCOM,	PPCVLE,	{FRT, FRA, FRC, FRB}},
{"fnma",	A(63,31,0),	A_MASK,      PWRCOM,	PPCNONE,	{FRT, FRA, FRC, FRB}},
{"fnmadd.",	A(63,31,1),	A_MASK,      PPCCOM,	PPCVLE,	{FRT, FRA, FRC, FRB}},
{"fnma.",	A(63,31,1),	A_MASK,      PWRCOM,	PPCNONE,	{FRT, FRA, FRC, FRB}},

{"fcmpo",	X(63,32),    X_MASK|(3<<21), COM,	PPCVLE,	{BF, FRA, FRB}},
...
{"fneg",	XRC(63,40,0),	XRA_MASK,    COM,	PPCVLE,	{FRT, FRB}},
{"fneg.",	XRC(63,40,1),	XRA_MASK,    COM,	PPCVLE,	{FRT, FRB}},
...
{"fmr",		XRC(63,72,0),	XRA_MASK,    COM,	PPCVLE,	{FRT, FRB}},
{"fmr.",	XRC(63,72,1),	XRA_MASK,    COM,	PPCVLE,	{FRT, FRB}},
...
{"fnabs",	XRC(63,136,0),	XRA_MASK,    COM,	PPCVLE,	{FRT, FRB}},
{"fnabs.",	XRC(63,136,1),	XRA_MASK,    COM,	PPCVLE,	{FRT, FRB}},
...
{"fabs",	XRC(63,264,0),	XRA_MASK,    COM,	PPCVLE,	{FRT, FRB}},
{"fabs.",	XRC(63,264,1),	XRA_MASK,    COM,	PPCVLE,	{FRT, FRB}},
...
{"mffs",	XRC(63,583,0),	XRARB_MASK,  COM,	PPCVLE,	{FRT}},
{"mffs.",	XRC(63,583,1),	XRARB_MASK,  COM,	PPCVLE,	{FRT}},
...
{"mtfsf",	XFL(63,711,0),	XFL_MASK,    COM, POWER6|PPCA2|PPC476|PPCVLE,	{FLM, FRB}},
{"mtfsf.",	XFL(63,711,1),	XFL_MASK, POWER6|PPCA2|PPC476, PPCVLE,	{FLM, FRB, XFL_L, W}},
{"mtfsf.",	XFL(63,711,1),	XFL_MASK,    COM, POWER6|PPCA2|PPC476|PPCVLE,	{FLM, FRB}},
...
#ifdef HTC_PPCVLE
 /* only for VLE to get operand list */
{"slwi",        X(63,0),              0,	     PPCVLE,	PPCNONE,         {RA, RS, SH}},
{"slwi.",       X(63,0),              0,	     PPCVLE,	PPCNONE,         {RA, RS, SH}},
{"srwi",        X(63,0),              0,	     PPCVLE,	PPCNONE,         {RA, RS, SH}},
{"srwi.",       X(63,0),              0,	     PPCVLE,	PPCNONE,         {RA, RS, SH}},
{"sync",        X(31,598),   0xffffffff,	     PPCVLE|BOOKE,	PPCNONE,         {LS}},
#endif /* ppc_vle */ /* ppc_vle */
};
...
#include "ppcvle-opc.h"
#include "ppc-zen-425-opc.h"
#include "ppc-zen-sat-opc.h"

const int ppczen425_num_opcodes = sizeof(ppczen425_opcodes) / sizeof(ppczen425_opcodes[0]);
const int ppczenefpu_num_opcodes = sizeof(ppczenefpu_opcodes) / sizeof(ppczenefpu_opcodes[0]);
const int ppczenlsp_num_opcodes = sizeof(ppczenlsp_opcodes) / sizeof(ppczenlsp_opcodes[0]);
const int ppczensat_num_opcodes = sizeof(ppczensat_opcodes) / sizeof(ppczensat_opcodes[0]);
const int ppcvle_num_opcodes = sizeof(ppcvle_opcodes) / sizeof(ppcvle_opcodes[0]);

const struct powerpc_opcode_table ppcvle_opcode_tables[] = {
  { ppczen425_opcodes,   &ppczen425_num_opcodes },
  { ppczenefpu_opcodes,  &ppczenefpu_num_opcodes },
  { ppczenlsp_opcodes,   &ppczenlsp_num_opcodes },
  { ppczensat_opcodes,   &ppczensat_num_opcodes },
  { ppcvle_opcodes,      &ppcvle_num_opcodes },
};

const int ppcvle_num_opcode_tables = sizeof(ppcvle_opcode_tables) / sizeof(ppcvle_opcode_tables[0]);
...
{"clrlslwi.",4, PPCCOM,	"rlwinm. %0,%1,%3,(%2)-(%3),31-(%3)"},
{"clrlwi", 3, PPCCOM,"rlwinm %0,%1,0,%2,31"},
{"clrlwi.",	3, PPCCOM,"rlwinm. %0,%1,0,%2,31"},

{"satsbs",   2, PPCCOM, "sat %0,%1,0,0,0,0 "},
{"satubs",   2, PPCCOM, "sat %0,%1,0,0,1,0 "},
{"satsbu",   2, PPCCOM, "sat %0,%1,0,1,0,0 "},
{"satubu",   2, PPCCOM, "sat %0,%1,0,1,1,0 "},
{"abssb",    2, PPCCOM, "sat %0,%1,0,0,0,1 "},
{"absub",    2, PPCCOM, "sat %0,%1,0,0,1,1 "},
{"satshs",   2, PPCCOM, "sat %0,%1,1,0,0,0 "},
{"satuhs",   2, PPCCOM, "sat %0,%1,1,0,1,0 "},
{"satshu",   2, PPCCOM, "sat %0,%1,1,1,0,0 "},
{"satuhu",   2, PPCCOM, "sat %0,%1,1,1,1,0 "},
{"abssh",    2, PPCCOM, "sat %0,%1,1,0,0,1 "},
{"absuh",    2, PPCCOM, "sat %0,%1,1,0,1,1 "},
{"satsws",   2, PPCCOM, "sat %0,%1,2,0,0,0 "},
{"satuws",   2, PPCCOM, "sat %0,%1,2,0,1,0 "},
{"satswu",   2, PPCCOM, "sat %0,%1,2,1,0,0 "},
{"satuwu",   2, PPCCOM, "sat %0,%1,2,1,1,0 "},
{"abssw",    2, PPCCOM, "sat %0,%1,2,0,0,1 "},
{"absuw",    2, PPCCOM, "sat %0,%1,2,0,1,1 "},
