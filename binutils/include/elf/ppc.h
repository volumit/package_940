...
/* Fake relocations for branch stubs, only used internally by ld.  */
  ...
  RELOC_NUMBER (R_PPC_VLE_RELAX32,	 52)
  RELOC_NUMBER (R_PPC_VLE_RELAX32PC,	 53)
  RELOC_NUMBER (R_PPC_VLE_RELAX32_PLT,	 54)
  RELOC_NUMBER (R_PPC_VLE_RELAX32PC_PLT, 55)
#endif
...
#define SHF_PPC_VLE             0x10000000      /* section contains VLE instructions */
#define PF_PPC_VLE              0x10000000      /* program header segment contains VLE \
                                                   instructions */
