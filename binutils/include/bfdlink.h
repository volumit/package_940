...
struct bfd_link_info
{
  ...
  /* TRUE if user should be informed about discarding output sections defining
     a symbol */
  unsigned int warn_discard_section: 1;
...
struct bfd_link_callbacks
{
  ...
  /* This callback emits a warning for fixing symbol from discarded 
     sections */
  bfd_boolean (*warn_fix_symbols)
     (struct bfd_link_info *, bfd *, const char *name,
      asection *from_sec, asection *to_sec);
};

