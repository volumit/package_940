...
ifile_p1:
	...
	|	INSERT_K BEFORE NAME
		{ lang_add_insert ($3, 1); }
    |   EXPORT_K OBJECT_K NAME 
        { lang_add_export_symbol($3,FALSE,
            0,
            NULL); }
    |   EXPORT_K OBJECT_K NAME AS_K NAME
        { lang_add_export_symbol($3,FALSE,
            0,
            $5); }
    |   EXPORT_K FUNCTION_K NAME 
        { lang_add_export_symbol($3,TRUE,
            0,
            NULL); }
    |   EXPORT_K FUNCTION_K NAME AS_K sec_name
        { lang_add_export_symbol($3,TRUE,
            0,
            $5); }
