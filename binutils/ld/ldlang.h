...
const char * lang_addr_to_memory_region
  (bfd_vma );
...
extern void lang_leave_group
  (void);
extern bfd_boolean lang_add_section
...
extern void lang_add_memory_region_map(const char *, bfd_vma , bfd_size_type , bfd_vma );
extern void lang_add_export_symbol(const char *, bfd_boolean , bfd_size_type , const char * );
